            ...
            <div class="col-sm-6">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form action="{{url('admin/content')}}" class="form-horizontal m-t" id="signupForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <div class="col-sm-8 col-sm-offset-3">
                                    ...
                                    <a class="btn btn-outline btn-default" href="{{url('admin/course/'.$request->course_id)}}" >返回</a>
                                </div>
                            </div>
                        </form>
                    </div>
