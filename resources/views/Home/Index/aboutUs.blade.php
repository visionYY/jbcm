                        ...
                        <div class="tab-pane fade {{$data['secId'] == 24 ? 'in active' : ''}}" id="home">
                            <div class="main-right">
                                ...
                                <div class="Company-profile">
                                    <p class="logo">
                                        <img src="{{asset('Home/images/jiabindaxue_logo.png')}}" alt="">
                                    </p>
                                    <h4 class="jj_tit">
                                        遍访天下公司、纪录时代商业。
                                    </h4>
                                ...
                                <div class="Company-profile">
                                    ...
                                    <div id="shrink">
                                        ...
                                        <dl>
                                            ...
                                            <dd>
                                            傲寒我们结婚 在稻城冰雪融化的早晨 傲寒我们结婚 在布满星辰斑斓的黄昏 傲寒我们结婚 让没发生过的梦都做完 忘掉那些过错和不被原谅的青春 直到有一天我不再歌唱 只担心你的未来与我无关 如果全世界都对你恶语相加
                                            </dd>
                                        </dl>
                                    </div>
                                </div>
